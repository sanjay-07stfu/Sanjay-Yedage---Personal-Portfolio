    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950">
      ...
      >
        ...
        <motion.div variants={itemVariants} className="flex justify-center gap-4 mb-8">
          {[
            { Icon: Github, href: portfolioData.social.github, delay: 0 },
            { Icon: Linkedin, href: portfolioData.social.linkedin, delay: 0.1 },
            { Icon: Mail, href: `mailto:${portfolioData.social.email}`, delay: 0.2 },
          ].map(({ Icon, href, delay }) => (
            <motion.a
              key={href}
              href={href}
        ...
        >
          {portfolioData.summary.split(" ").map((word, i) => (
            <motion.span
              key={i}
